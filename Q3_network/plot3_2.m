...
title({'Number of infected students over time';'p = 0.01'}, 'FontSize', 16)
saveas(figure2,'infectp001.png');
...
ylabel('Number of infected students','FontSize',14)
title({'Number of infected students over time';'p = 0.001:0.001:0.01'}, 'FontSize', 16)
saveas(figure3,'infectp10r.png');
...
%legend('p = 0.001','p = 0.002','p = 0.003','p = 0.004','p = 0.005','p = 0.006','p = 0.007','p = 0.008','p = 0.009','p = 0.01','location','eastoutside');
ylabel('Number of infected students','FontSize',14)
title({'Number of infected students vs r/p'}, 'FontSize', 16)
saveas(figure4,'infectprp.png');